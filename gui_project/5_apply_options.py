...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir=r"C:\Users\com\Desktop\coding\python practice") # 최초에 C:/ 경로를 보여줌
...
def merge_image():
    ...
    try:
        ...
        for idx, img in enumerate(images):
            ...
            progress = (idx + 1) / len(images) * 100 # 실제 percent 정보를 게산
            p_var.set(progress)
            progress_bar.update
